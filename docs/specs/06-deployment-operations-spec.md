...
BrokerGate 默认面向自部署。首版部署目标是单台香港 VPS，使用 Docker Compose 运行 API 服务和后续的 Web 面板。
...
- `BROKERGATE_BROKER_MODE`
- `BROKERGATE_TIGER_ENABLED`
- `BROKERGATE_TIGER_ACCOUNT`
- `BROKERGATE_TIGER_ID`
- `BROKERGATE_TIGER_LICENSE`
